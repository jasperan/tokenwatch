...
>
> ```bash
> curl -fsSL https://raw.githubusercontent.com/jasperan/tokenwatch/main/install.sh | bash
> ```
>
...
> ```bash
> PROJECT_DIR=/opt/myapp curl -fsSL https://raw.githubusercontent.com/jasperan/tokenwatch/main/install.sh | bash
> ```
>
> Or install manually:
> ```bash
> git clone https://github.com/jasperan/tokenwatch.git
> cd tokenwatch
